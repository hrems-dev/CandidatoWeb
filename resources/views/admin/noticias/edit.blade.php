    ...
    <div class="flex-1 overflow-auto">
        ...
        <div class="bg-white border-b border-gray-200 p-6 flex justify-between items-center">
            <div>
                ...
                <h1 class="text-3xl font-bold text-gray-800">Editar Noticia</h1>
            </div>
        </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md max-w-4xl">
                <form method="POST" action="#" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" value="Noticia Importante" required class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-900">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea required rows="8" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-900">Contenido de la noticia...</textarea>
                    </div>
